export const cities = [
  ...
  { id: 3, name: 'भोपाल', englishName: 'Bhopal', lat: 23.2599, lng: 77.4126 },
  {
    id: 4,
    name: 'ಬೆಂಗಳೂರು',
  ...
  { id: 9, name: 'इंदौर', englishName: 'Indore', lat: 22.7196, lng: 75.8577 },
  { id: 10, name: 'जयपुर', englishName: 'Jaipur', lat: 26.9124, lng: 75.7873 },
  { id: 11, name: 'कोच्चि', englishName: 'Kochi', lat: 9.9312, lng: 76.2673 },
  {
    id: 12,
    name: 'কলকাতা',
    englishName: 'Kolkata',
  ...
  { id: 13, name: 'लखनऊ', englishName: 'Lucknow', lat: 26.8467, lng: 80.9462 },
  { id: 14, name: 'मुंबई', englishName: 'Mumbai', lat: 19.076, lng: 72.8777 },
  {
    id: 15,
    name: 'சென்னை',
    englishName: 'Chennai',
