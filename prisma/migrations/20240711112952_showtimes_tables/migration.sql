-- CreateEnum
CREATE TYPE "ProjectionType" AS ENUM ('STANDARD', 'IMAX', 'DOLBY_ATOMS', 'RPX', 'SCREENX', 'PLF');

-- CreateEnum
CREATE TYPE "SoundSystemType" AS ENUM ('MONO', 'STEREO', 'DOLBY_DIGITAL', 'DOLBY_ATOMS', 'DTS', 'DTS_X', 'SONY_SDDS', 'AURO_3D', 'IMAX_ENHANCED');
...
CREATE TABLE "Screen" (
    ...
    "soundSystemType" "SoundSystemType" NOT NULL DEFAULT 'DOLBY_ATOMS',
